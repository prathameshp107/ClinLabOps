                            ...
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-start sm:items-center justify-between">
                                ...
                                <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto justify-start sm:justify-end">
                                    ...
                                    <div className="inline-flex items-center rounded-full border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/40 shadow-sm overflow-hidden">
                                        <div className="inline-flex items-center justify-center whitespace-nowrap px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold bg-primary text-white shadow-md border-r border-gray-200 dark:border-gray-800">
                                            <List className="mr-1 sm:mr-2 h-3 w-3 sm:h-4 sm:w-4" />
                                            <span className="hidden xs:inline">Table</span>
                                        </div>
                                        <div className="inline-flex items-center justify-center whitespace-nowrap px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold text-muted-foreground bg-transparent">
                                            <Grid className="mr-1 sm:mr-2 h-3 w-3 sm:h-4 sm:w-4" />
                                            <span className="hidden xs:inline">Grid</span>
                                        </div>
                                    </div>
                                    <Skeleton className="h-9 sm:h-10 w-24 rounded-md" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-full">
                            ...
                            <div className="w-full overflow-hidden rounded-lg sm:rounded-2xl border shadow-lg bg-white dark:bg-gray-950">
                                <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent">
                                    {/* Table Header */}
                                    <div className="grid grid-cols-6 gap-4 px-4 py-3 border-b bg-gray-50 dark:bg-gray-900/40">

...
const ContextMenuSubTrigger = React.forwardRef(function ContextMenuSubTrigger({ className, inset, children, rightIcon: RightIcon = ChevronRight, ...props }, ref) {
  return (
    ...
    >
      {children}
      {RightIcon && <RightIcon className="ml-auto h-4 w-4" />}
    </ContextMenuPrimitive.SubTrigger>
  );
});

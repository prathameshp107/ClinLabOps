    ...
    <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-700/40 border border-gray-200 dark:border-gray-600 rounded-xl mt-4 shadow-sm">
      ...
      <div className="flex items-center space-x-6 lg:space-x-8">
        ...
        <div className="flex w-[100px] items-center justify-center text-sm font-medium dark:text-white">
          Page <span className="mx-1 px-2 py-0.5 rounded bg-primary/10 text-primary font-semibold">{table.getState().pagination.pageIndex + 1}</span> of {table.getPageCount()}
        </div>
        <div className="flex items-center space-x-2">
          <Button
            variant="outline"
            className="hidden h-8 w-8 p-0 rounded-md lg:flex"

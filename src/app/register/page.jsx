...
export default function RegisterPage() {
  ...
  // The commented out useEffect for fetching animation is removed
  // Fetch animation data - lab-themed animation
  // useEffect(() => {
  //   // Using a different publicly accessible science/laboratory themed animation
  //   fetch('https://assets3.lottiefiles.com/packages/lf20_jvkgb2yg.json')
  //     .then(response => response.json())
  //     .then(data => setAnimationData(data))
  //     .catch(error => {
